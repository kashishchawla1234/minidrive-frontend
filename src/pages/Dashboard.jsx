...
export default function Dashboard() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#fffaf5] to-[#f7ede2] p-8 overflow-hidden">
      {loading && (
        <div
          style={{
            position: "fixed",
      ...
      <h2 className="text-3xl font-semibold mb-6 text-[#3a2e25]">My Files</h2>
          ...
          {files.map((file) => (
            ...
            >
              <button
                ...
                className="absolute top-3 right-3 text-red-600 hover:text-red-800 border-none bg-transparent"
              >
                <Trash2 size={20} />
              </button>
